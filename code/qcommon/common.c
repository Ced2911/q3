...
#define DEF_COMHUNKMEGS		192 //64
#define DEF_COMZONEMEGS		48 //24
...
void Com_InitHunkMemory( void ) {
	...
	//s_hunkData = (byte *)HeapAlloc(GetProcessHeap(), HEAP_ZERO_MEMORY, s_hunkTotal + 127);
	//s_hunkData = (byte*)XPhysicalAlloc(s_hunkTotal + 127, MAXULONG_PTR, 128, PAGE_READWRITE);
	if ( !s_hunkData ) {
